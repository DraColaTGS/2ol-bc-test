...
const embed = new Discord.RichEmbed() .setColor("RANDOM").setDescription(`**${prefixbc}bc ⇏ لإرسال رسالة إلى جميع أعضاء السيرفر
${prefixbc}obc ⇏ لإرسال رسالة إلى الأعضاء الأونلاين فقط
